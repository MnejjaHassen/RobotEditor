...
class SetupMainWindow:
    ...
    def setup_gui(self):
        ...
        if self.settings["custom_title_bar"]:
            ...
            self.ui.title_bar.set_title("Welcome to Robot Editor")
        ...
        def update_label():
            ...
            # change Size
            self.ui.load_pages.page_2.setStyleSheet(f"font-size:{value}pt")
